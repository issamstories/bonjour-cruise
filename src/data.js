...
// { name, code } — the flag emoji is derived from the ISO 3166-1 alpha-2 code.
export const COUNTRIES = [
  ...
  { name: 'Kiribati', code: 'KI' }, { name: 'Kosovo', code: 'XK' },
...
export const LANGUAGES = [
  ...
  'Azerbaijani', 'Balochi', 'Bambara', 'Basque', 'Belarusian', 'Bengali',
  'Bosnian', 'Bulgarian', 'Burmese', 'Cantonese', 'Catalan', 'Cebuano', 'Chichewa',
  'Croatian', 'Czech', 'Danish', 'Dari', 'Dutch', 'English', 'Estonian', 'Ewe',
  'Faroese', 'Finnish', 'French', 'Fula', 'Galician', 'Georgian', 'German', 'Greek',
  ...
  'Malay', 'Malayalam', 'Maltese', 'Mandarin Chinese', 'Maori', 'Marathi', 'Mongolian',
  'Nepali', 'Norwegian', 'Odia', 'Oromo', 'Pashto', 'Persian (Farsi)', 'Polish',
  'Portuguese', 'Punjabi', 'Quechua', 'Romanian', 'Russian', 'Samoan', 'Sanskrit',
  'Scottish Gaelic', 'Serbian', 'Sesotho', 'Shona', 'Sindhi', 'Sinhala', 'Slovak',
  'Slovenian', 'Somali', 'Spanish', 'Sundanese', 'Swahili', 'Swedish',
  'Tagalog (Filipino)', 'Tajik', 'Tamazight (Berber)', 'Tamil', 'Tatar', 'Telugu',
  'Thai', 'Tibetan', 'Tigrinya', 'Turkish', 'Turkmen', 'Twi', 'Ukrainian', 'Urdu',
